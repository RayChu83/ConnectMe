          ...
          <>
            <article className="post" style={{maxHeight: "unset"}}>
              <div className="post--details" style={{flexDirection : "unset", alignItems : "center"}}>
                ...
                <article>
                  <button className='unstyled--btn pointer' onClick={editPost}><i className="fa-solid fa-pen-to-square green--text"></i></button>
                  <button className='unstyled--btn pointer' onClick={removePost}><i className="fa-solid fa-trash danger--text"></i></button>
                </article>}  
              </div>
              ...
              <section className="post--interactions">
                ...
                ? 
                  <button className='unstyled--btn pointer liked' onClick={unlike}><i className="fa-solid fa-heart liked"></i> {post.likes?.length || 0} Like{post.likes?.length !== 1 && "s"}</button> 
                : 
                  <button className='unstyled--btn pointer understated' onClick={like}><i className="fa-solid fa-heart understated"></i> {post.likes?.length || 0} Like{post.likes?.length !== 1 && "s"}</button>
                }
              </section>
            </article>
          </> 
